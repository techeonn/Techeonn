...
const ProjectPage = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      const orderResponse = await axios.post('http://localhost:3000/api/payments/create-order', {
      ...
      const options = {
        ...
        handler: async (response) => {
          ...
          try {
            const verifyResponse = await axios.post('http://localhost:3000/api/payments/verify-payment', {
